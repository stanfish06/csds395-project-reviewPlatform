...
import QuestionCardPage from "../component/QuestionCardPage_testing";
import {
  Box,
  IconButton,
  Heading,
...
function SearchQuestions({ _alltags, questions, userInf }) {
  ...
  const handleSubmit = async (event) => {
    ...
    console.log(keyword);
    router.push(`/searchQuestions_testing?term=${keyword}`);
    window.location.replace(`/searchQuestions_testing?term=${keyword}`);
    setKeyword("");
  };
  return (
    <>
